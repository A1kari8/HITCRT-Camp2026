...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/test1', ['videos/test1/depth.mp4']),
        ('share/' + package_name + '/test2', ['videos/test2/depth.mp4']),
        ('share/' + package_name + '/test3', ['videos/test3/depth.mp4']),
        ('share/' + package_name + '/test4', ['videos/test4/depth.mp4']),
        ('share/' + package_name + '/test5', ['videos/test5/depth.mp4']),
